...
const imageToggleButtons = document.querySelectorAll('input[type="radio"][name="image-toggle"]');
const myImage = document.getElementById('myImage');

imageToggleButtons.forEach((button) => {
  button.addEventListener('change', () => {
    const selectedImage = button.id === 'radio1' ? 'images/hub1.jpg' : 'images/scene.jpg';
